...
SELECT emprestimo.data_emprestimo, professor.nome, guarda_volume.codigo, guarda_volume.bloco
 FROM emprestimo INNER JOIN professor
  ON (emprestimo.id_professor = professor.id_professor) INNER JOIN itens_de_emprestimo
  ON(emprestimo.id_emprestimo = itens_de_emprestimo.id_emprestimo) INNER JOIN guarda_volume
  ON(itens_de_emprestimo.id_guarda_volume = guarda_volume.id_guarda_volume);
